...
st.session_state["_page_signup"]   = signup_page
st.session_state["_page_reset"]    = reset_page
st.session_state["_page_home"]     = home_page
st.session_state["_page_reports"]  = reports_page
st.session_state["_page_pricing"]  = pricing_page
st.session_state["_page_settings"] = settings_page
